...
<div class="form-group">
    ...
    {{ Form::text('nik', 'Masukkan NIK', ['class' => ["form-control", 'is-invalid'=>$errors]]) }}
...
{{--Pendidikan--}}
<div class="form-group">
    <label class="form-label" for="pendidikan">Kewarganegaraan:</label>
    <select id="pendidikan" class="form-control @error('pendidikan') is-invalid @enderror">
...
<div class="form-group">
    ...
    <select id="pekerjaan" class="form-control @error('pekerjaan') is-invalid @enderror">
...
<div class="form-group">
    ...
    <select id="kwn" class="form-control @error('kwn') is-invalid @enderror">
        <option value="" selected disabled>--Pilih Kewrganegaraan--</option>
        @foreach($kwns as $kwn)
